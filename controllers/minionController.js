...
export const getMemeById = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Error al obtener el meme ☠️☠️☠️", detalles: error.message });
  }
};
...
export const updateMeme = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Error al actualizar el meme ☠️☠️☠️", detalles: error.message });
  }
};
...
export const deleteMeme = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Error al eliminar el meme ☠️☠️☠️", detalles: error.message });
  }
};
