import MinionModel from "../models/minionModel.js";
...
export const obtenerMemes = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Error al obtener los memes", detalles: error.message });
  }
};
