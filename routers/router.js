...
import { crearMeme, obtenerMemes, obtenerMemePorId, actualizarMeme, eliminarMeme } from "../controllers/minionController.js";

const router = express.Router();

router.post("/memes", crearMeme); // Crear un meme
router.get("/memes", obtenerMemes); // Obtener todos los memes
